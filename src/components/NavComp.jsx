...
function NavComp() {
  ...
  return (
   <div id='navContainer'>
    ...
    <div>
        <Link to = "/createpost" style={{textDecoration:"none"}}><h3 style={{color:"tomato"}}>Create Todo</h3></Link>
        </div>
        <div>
        {/* <Link to = "/myposts" style={{textDecoration:"none"}} ><h3 style={{color:"tomato"}}>My Posts</h3></Link> */}
        </div>
        <div>
        <Link to = "/mytodos" style={{textDecoration:"none"}} ><h3 style={{color:"tomato"}}>My Todos</h3></Link>
        </div>
